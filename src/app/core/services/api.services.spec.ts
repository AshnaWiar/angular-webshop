...
describe('ApiService', () => {
  ...
  it('should create valid url', () => {
    const expectedURL = environment.endpoints.API + '/user?name=bob&age=2';
  ...
  it('should execute GET request', () => {
    ...
    const req = httpMock.expectOne(environment.endpoints.API + '/user?name=bob');
  ...
  it('should execute POST request', () => {
    ...
    const req = httpMock.expectOne(environment.endpoints.API + '/user');
  ...
  it('should execute DELETE request', () => {
    ...
    httpMock.expectOne(environment.endpoints.API + '/user/1');
  });
